...
![image](https://github.com/maxiro-samurai/picx-images-hosting/raw/master/image.1lbzaonmo2.webp)


静态：

1. 戴维宁以及环路方程与MOSFET转移曲线方程联立可得I<sub>DQ</sub>，U<sub>GSQ</sub>


2. 动态等效图
![image](https://github.com/maxiro-samurai/picx-images-hosting/raw/master/image.2vewi8algm.webp)

    放大倍数$$A_u = \frac{u_o}{u_i} = \frac{g_m u_{gs} R_S // R_L}{u_{gs} + g_m u_{gs} R_S // R_L} = \frac{g_m R_S // R_L}{1 + g_m R_S // R_L} $$

    输入电阻很简单就是R<sub>G1</sub>与R<sub>G2</sub>并联
3. 输出电阻

    信号源短接，从输出口接入一个信号源，从输出口中看进去的电阻

    ![image](https://github.com/maxiro-samurai/picx-images-hosting/raw/master/image.5fkquvmvcz.webp)


    需要注意电流方向与电压方向

    $$i = i_R - i_d = \frac{u}{R_S} + g_m u$$

    $$r_o = \frac{u}{i} = R_S / \left( \frac{1}{g_m} \right) = 1000 / / 28.7 = 27.9 \Omega $$
