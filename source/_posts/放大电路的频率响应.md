...
下限截止频率f<sub>L</sub>：从中频区开始向左，增益随着频率上升下降到中频区A<sub>m</sub>的0.707倍时，此时的频率用f<sub>L</sub>表示。
...
![image](https://github.com/maxiro-samurai/picx-images-hosting/raw/master/image.4n7yfm5zln.webp)
